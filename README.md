...
- 📌 **Drop-to-pin slot** — drag any app (from a drawer or the suggestions) toward the circle that appears above the trio and drop it: it stays pinned there for a few hours (duration, manual pick, and a rotating multi-app mode in settings). The slot leans toward your finger as the drag approaches.
