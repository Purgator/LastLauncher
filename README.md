...
- 🧠 **Launcher memory** — on-device prediction from time of day, weekday rhythm, app-to-app sequences, and context triggers (Bluetooth, headphones, charging, joining/leaving Wi-Fi, losing/regaining signal, starting to move — via the ultra-low-power significant-motion sensor, never the raw accelerometer). It also learns from your corrections: swipe the suggestions away and open something else within seconds, and what was shown gets quieter at that time of day — swiping just to play changes nothing.
